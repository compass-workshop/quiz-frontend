<template>
    <div>
      ...
      <QuizQuestion v-for="(question, index) in question" :key="index" :question="question" :indexs="index" :options="options[index]"  :questionIndex="index" @selectAnswer="changeAnswer"/>
